...
describe('isEqual primitives', () => {
  ...
  bench('react-fast-compare', () => {
    isEqualReactFastCompare(1, 1)
    isEqualReactFastCompare(NaN, NaN)
    isEqualReactFastCompare(+0, -0)

    isEqualReactFastCompare(true, true)
    isEqualReactFastCompare(true, false)

    isEqualReactFastCompare('hello', 'hello')
    isEqualReactFastCompare('hello', 'world')
  })
})
...
describe('isEqual dates', () => {
  ...
  bench('react-fast-compare', () => {
    isEqualReactFastCompare(new Date('2020-01-01'), new Date('2020-01-01'))
    isEqualReactFastCompare(new Date('2020-01-01'), new Date('2021-01-01'))
  })
})
...
describe('isEqual RegExps', () => {
  ...
  bench('react-fast-compare', () => {
    isEqualReactFastCompare(/hello/g, /hello/g)
    isEqualReactFastCompare(/hello/g, /hello/i)
  })
})
...
describe('isEqual objects', () => {
  ...
  bench('react-fast-compare', () => {
    isEqualReactFastCompare({ a: 1, b: { c: 2 } }, { a: 1, b: { c: 2 } })
    isEqualReactFastCompare({ a: 1, b: { c: 2 } }, { a: 1, b: { c: 3 } })
    isEqualReactFastCompare({ a: 1, b: 2 }, { a: 1, b: 2 })
  })
})
...
describe('isEqual arrays', () => {
  ...
  bench('react-fast-compare', () => {
    isEqualReactFastCompare([1, 2, 3], [1, 2, 3])
    isEqualReactFastCompare([1, 2, 3], [1, 2, 4])
  })
})
